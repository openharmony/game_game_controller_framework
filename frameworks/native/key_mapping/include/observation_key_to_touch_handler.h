...
#ifndef GAME_CONTROLLER_FRAMEWORK_OBSERVATION_KEY_TO_TOUCH_HANDLER_H
#define GAME_CONTROLLER_FRAMEWORK_OBSERVATION_KEY_TO_TOUCH_HANDLER_H

#include "key_to_touch_handler.h"

namespace OHOS {
namespace GameController {
class ObservationKeyToTouchHandler : public BaseKeyToTouchHandler {
public:
...
#endif //GAME_CONTROLLER_FRAMEWORK_OBSERVATION_KEY_TO_TOUCH_HANDLER_H
