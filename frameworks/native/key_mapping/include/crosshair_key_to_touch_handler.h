 ...
 */
#ifndef GAME_CONTROLLER_FRAMEWORK_CROSSHAIR_KEY_TO_TOUCH_HANDLER_H
#define GAME_CONTROLLER_FRAMEWORK_CROSSHAIR_KEY_TO_TOUCH_HANDLER_H

#include "key_to_touch_handler.h"

namespace OHOS {
namespace GameController {
class CrosshairKeyToTouchHandler : public BaseKeyToTouchHandler {
public:
...
private:
    bool isSendDownTouch_{true};
};
}
}

#endif //GAME_CONTROLLER_FRAMEWORK_CROSSHAIR_KEY_TO_TOUCH_HANDLER_H
