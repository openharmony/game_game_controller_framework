...
void InputEventCallbackTest::SetUp()
{
    ...
    DelayedSingleton<InputEventCallback>::GetInstance()->gamePadNonstandardButtonCallback_ = nullptr;
}
...
/**
* @tc.name: OnGamePadNonstandardButtonEventCallback_001
* @tc.desc: If a callback method exists, the callback is successful.
* @tc.type: FUNC
* @tc.require: issueNumber
*/
HWTEST_F(InputEventCallbackTest, OnGamePadNonstandardButtonEventCallback_001, TestSize.Level0)
{
    std::shared_ptr<GamePadButtonEventCallback> callback = std::make_shared<GamePadButtonEventCallback>();
    DelayedSingleton<InputEventCallback>::GetInstance()
        ->RegisterNonstandardButtonEventCallback(ApiTypeEnum::CAPI, callback);
    GamePadButtonEvent buttonEvent;
    buttonEvent.id = 11;
...
/**
* @tc.name: OnGamePadNonstandardButtonEventCallback_002
* @tc.desc: If no callback method exists, the event is discarded.
* @tc.type: FUNC
* @tc.require: issueNumber
*/
HWTEST_F(InputEventCallbackTest, OnGamePadNonstandardButtonEventCallback_002, TestSize.Level0)
{
    GamePadButtonEvent buttonEvent;
    buttonEvent.id = 11;
    buttonEvent.keyCodeName = "ButtonFn";
...
/**
* @tc.name: RegisterNonstandardButtonEventCallback_001
* @tc.desc: If the value of callback is nullptr, the system discards the callback.
* @tc.type: FUNC
* @tc.require: issueNumber
*/
HWTEST_F(InputEventCallbackTest, RegisterNonstandardButtonEventCallback_001, TestSize.Level0)
{
    DelayedSingleton<InputEventCallback>::GetInstance()
        ->RegisterNonstandardButtonEventCallback(ApiTypeEnum::CAPI, nullptr);
    ASSERT_EQ(nullptr, DelayedSingleton<InputEventCallback>::GetInstance()->gamePadNonstandardButtonCallback_);
}

/**
* @tc.name: RegisterNonstandardButtonEventCallback_002
* @tc.desc: If the value of callback is not nullptr, the callback is cached.
* @tc.type: FUNC
* @tc.require: issueNumber
*/
HWTEST_F(InputEventCallbackTest, RegisterNonstandardButtonEventCallback_002, TestSize.Level0)
{
    std::shared_ptr<GamePadButtonEventCallback> callback = std::make_shared<GamePadButtonEventCallback>();
    DelayedSingleton<InputEventCallback>::GetInstance()
        ->RegisterNonstandardButtonEventCallback(ApiTypeEnum::CAPI, callback);
    ASSERT_NE(nullptr, DelayedSingleton<InputEventCallback>::GetInstance()->gamePadNonstandardButtonCallback_);
}

/**
* @tc.name: UnRegisterNonstandardButtonEventCallback_001
* @tc.desc: Cancel the callback event of unknown button.
* @tc.type: FUNC
* @tc.require: issueNumber
*/
HWTEST_F(InputEventCallbackTest, UnRegisterNonstandardButtonEventCallback_001, TestSize.Level0)
{
    std::shared_ptr<GamePadButtonEventCallback> callback = std::make_shared<GamePadButtonEventCallback>();
    DelayedSingleton<InputEventCallback>::GetInstance()
        ->RegisterNonstandardButtonEventCallback(ApiTypeEnum::CAPI, callback);
    DelayedSingleton<InputEventCallback>::GetInstance()
        ->UnRegisterNonstandardButtonEventCallback(ApiTypeEnum::CAPI);
    ASSERT_EQ(nullptr, DelayedSingleton<InputEventCallback>::GetInstance()->gamePadNonstandardButtonCallback_);
}
